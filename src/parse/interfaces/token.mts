 ...
 *
 * Tokens are the core of what the parser produces.
 * Libraries and other tools can turn them into different things.
 *
 * Tokens are essentially names attached to a slice of character codes,
 * such as `eof` for end of file, or `whitespace` for whitespace characters.
 *
